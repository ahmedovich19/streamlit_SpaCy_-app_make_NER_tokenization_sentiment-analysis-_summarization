...
Author: [Ahmed Hamdy(AhmedHamdy)](https://github.com/AhmedHamdy))\n
Source: [Github](https://github.com/AhmedHamdy/Streamlit_DataScience_Apps/)
...
def main():
	...
	st.sidebar.text("Ahmed Hamdy(AhmedHamdy)")
	st.sidebar.text("Ahmed Hamdy@AhmedHamdyTech")
